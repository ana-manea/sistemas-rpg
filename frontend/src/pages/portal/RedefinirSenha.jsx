...
export default function RedefinirSenha() {
  ...
  return (
    <form className="card form" onSubmit={submit}>
      <h1>Nova senha</h1>
      {!token && <p className="notice">Link de recuperação inválido ou incompleto.</p>}
      ...
      <button className="primary" disabled={loading || !token}>{loading ? 'Salvando...' : 'Redefinir senha'}</button>
